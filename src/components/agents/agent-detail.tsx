    ...
    >
      ...
      <div className="mt-6 grid grid-cols-3 gap-4">
        <div className="rounded-lg border border-[#1f1f1f] bg-[#0a0a0a] p-3">
          <p className="text-[10px] font-medium uppercase tracking-wider text-[#525252]">Status</p>
        ...
        <div className="rounded-lg border border-[#1f1f1f] bg-[#0a0a0a] p-3">
          <p className="text-[10px] font-medium uppercase tracking-wider text-[#525252]">Machine</p>
          <p className="mt-1 font-mono text-sm text-white">{agent.machine}</p>
        </div>
        <div className="rounded-lg border border-[#1f1f1f] bg-[#0a0a0a] p-3">
          <p className="text-[10px] font-medium uppercase tracking-wider text-[#525252]">Last Active</p>
      ...
      {agent.currentTask && (
        <div className="mt-4">
          <h3 className="text-xs font-medium uppercase tracking-wider text-[#525252]">Current Task</h3>
      ...
      <div className="mt-4">
        <h3 className="text-xs font-medium uppercase tracking-wider text-[#525252]">About</h3>
        <p className="mt-2 text-sm leading-relaxed text-[#a3a3a3]">{agent.description}</p>
      </div>

      <div className="mt-4">
        <h3 className="text-xs font-medium uppercase tracking-wider text-[#525252]">Skills</h3>
