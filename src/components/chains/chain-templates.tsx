    ...
    steps: [
      {
        ...
        trigger: { type: "manual" },
        action: { type: "start-task", agentId: "main", taskTitle: "Check prospect queue", taskDescription: "Review and validate outreach prospect list" },
        status: "pending",
        onFailure: "stop",
        maxRetries: 0,
        retryCount: 0,
      },
      {
        ...
        action: { type: "start-task", agentId: "main", taskTitle: "Send outreach DMs", taskDescription: "Process and send personalized DMs to verified prospects" },
        status: "pending",
        onFailure: "retry",
        maxRetries: 2,
        retryCount: 0,
    ...
    steps: [
      {
        ...
        name: "Run tests",
        trigger: { type: "manual" },
        action: { type: "start-task", agentId: "main", taskTitle: "Run test suite", taskDescription: "Execute all unit and integration tests" },
        status: "pending",
        onFailure: "stop",
        maxRetries: 0,
        retryCount: 0,
      },
      {
        ...
        name: "Build project",
        trigger: { type: "task-complete" },
        action: { type: "start-task", agentId: "main", taskTitle: "Build production", taskDescription: "Create production build" },
        status: "pending",
        onFailure: "stop",
        maxRetries: 0,
        retryCount: 0,
      ...
      },
      {
        ...
        action: { type: "start-task", agentId: "main", taskTitle: "Health check", taskDescription: "Verify deployment is healthy and responding" },
        status: "pending",
        onFailure: "retry",
        maxRetries: 3,
        retryCount: 0,
    ...
    steps: [
      {
        ...
        name: "Web search",
        trigger: { type: "manual" },
        action: { type: "start-task", agentId: "main", taskTitle: "Research topic", taskDescription: "Conduct web search and gather information" },
        status: "pending",
        onFailure: "stop",
        maxRetries: 0,
        retryCount: 0,
      },
      {
        ...
        name: "Compile report",
        trigger: { type: "task-complete" },
        action: { type: "start-task", agentId: "main", taskTitle: "Compile findings", taskDescription: "Organize and compile research findings into a report" },
        status: "pending",
        onFailure: "retry",
        maxRetries: 1,
        retryCount: 0,
